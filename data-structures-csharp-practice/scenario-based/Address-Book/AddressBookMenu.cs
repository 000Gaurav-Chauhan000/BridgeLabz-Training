    ...
    class AddressBookMenu
    {
        public void ShowMenu()
        {
            ...
            do
            {
                ...
                {
                    case 1: return;
                    case 2: addressBookUtility.AddContact(); 
                    break;
                    case 3: addressBookUtility.DisplayContacts();
                    break;
                    case 4: addressBookUtility.EditExistingContact(); 
                    break;
                    case 5: addressBookUtility.DeleteContactByName(); 
                    break;
                    case 6: addressBookUtility.AddMultiplePersons(); 
                    break;
                    case 7: addressBookUtility.SearchPersonByCityOrState(); 
                    break;
                    case 8: addressBookUtility.ViewPersonsByCityOrState(); 
                    break;
                    case 9: addressBookUtility.CountPersonsByCityOrState(); 
                    break;
                    case 10: addressBookUtility.SortEntriesByPersonName(); 
                    break;
